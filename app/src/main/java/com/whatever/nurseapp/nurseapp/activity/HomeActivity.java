...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nurseManageBtn = (Button)findViewById(R.id.nurse_manage);
        newOrderBtn = (Button) findViewById(R.id.new_order);
        oldOrderBtn = (Button) findViewById(R.id.old_order);

        nurseManageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                        Intent intent = new Intent(HomeActivity.this, NurseManageActivity.class);
        ...
        newOrderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent toNewOrder = new Intent(HomeActivity.this, NewOrderActivity.class);
        ...
        oldOrderBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toOldOrder = new Intent(HomeActivity.this, OldOrderActivity.class);
